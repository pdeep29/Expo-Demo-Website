...
export default function ServicesScreen() {
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <Pressable onPress={() => {
                        if (Platform.OS === 'web') {
                            const confirmed = window.confirm('Are you sure you want to delete Service');
                            if (confirmed) {
                            ...
                            Alert.alert('Alert', 'Are you sure you want to delete Service', [{
                                text: "No",
    ...
    return (
        <View style={styles.container}>
            ...
            <AppBarWithBackIcon title={' Services'} isAdd={true} onPressAdd={() => { openEditModal() }} />
                ...
                <View style={styles.modalContainer}>
                    <View style={[styles.modalContent, { width: modalWidth }]}>
                        <Text style={styles.modalTitle}>
                            {formData?.id && products.find(p => p.id === formData.id) ? "Edit" : "Add"} Service
                        </Text>
                        <TextInput
                            placeholder="Title"
                            style={styles.input}
